...
public class RunBuildUserDatabase
{
	...
	public static ExeOptionsFactory OPTIONS_FACTORY = new ExeOptionsFactory() {
		...
		public ExeOptions createOptions()
		{
			...
			OptionHelper.addL(options, OPTION_OUTPUT, true, true, "file", "a sqlite database file");
			// @formatter:on
			...
			throws Exception
	{
		...
		BuildUserDatabase task = new BuildUserDatabase(pathInput, pathOutput);
		task.execute();
	}
